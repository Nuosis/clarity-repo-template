...
READ the original project charter from `ai_docs/context/project_docs/project_charter.md`.
...
**ALWAYS update in place**: `ai_docs/context/project_docs/project_charter.md`
