...
READ the current PRD from `ai_docs/context/project_docs/prd.md`.
ANALYZE the WBS change history in `ai_docs/context/project_docs/wbs.md`.
...
**ALWAYS update in place**: `ai_docs/context/project_docs/prd.md`
