...
READ the WBS document from `ai_docs/context/project_docs/wbs.md`.
...
1. **Read Current WBS**
   - Use the Read tool to examine `ai_docs/context/project_docs/wbs.md`
...
**ALWAYS update the existing WBS**: `ai_docs/context/project_docs/wbs.md`
